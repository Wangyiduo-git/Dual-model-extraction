...
def process_pdf(pdf_file_path, output_folder):
    ...
    try:
        ...
        # Prepare prompt for first model (classification)
        classification_prompt = f"""
        Please determine if the following text is related to battery life or capacity degradation. 
        ...
        # Prepare prompt for second model (extraction)
        extraction_prompt = f"""
